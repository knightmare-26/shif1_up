...
from services.timing_board import (  # noqa: E402  (re-exported: tests and callers use live.poller)
    SESSIONS, TIMED_SESSIONS, TIMED_SESSION_END_STALL_SECONDS, build_classified_positions,
    build_driver_rows, build_race_id, build_timed_positions, is_timed_session, sector_status,
    _format_lap_time, _format_sector,
)
